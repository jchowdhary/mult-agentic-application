    ...
    for day_offset in range(10):
        ...
        schedule = {
            ...
            "appointments": [
                ...
                {"time": "13:00-15:00", "activity": "Errands and shopping", "type": "leisure"},
                {"time": "15:00-16:00", "activity": "Tea time", "type": "flexible"},
                {"time": "16:00-18:00", "activity": "Hobbies and TV", "type": "leisure"},
        ...
        if day_offset % 3 == 0:
            schedule["appointments"][3] = {"time": "12:00-13:00", "activity": "Lunch with friends", "type": "fixed"}
        if day_offset % 4 == 0:
            schedule["appointments"][4] = {"time": "13:00-15:00", "activity": "Car maintenance", "type": "fixed"}
